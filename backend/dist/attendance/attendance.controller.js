...
let AttendanceController = class AttendanceController {
    ...
    updateRecord(id, body, req) {
        return this.attendanceService.updateRecord(id, req.user.id, body);
    }
    updateEntry(recordId, studentId, body, req) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], AttendanceController.prototype, "getClassRecords", null);
__decorate([
    (0, common_1.Get)('class/:classId/summary'),
    __param(0, (0, common_1.Param)('classId')),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
...
__decorate([
    (0, common_1.Patch)(':recordId/entry/:studentId'),
    ...
    __metadata("design:returntype", void 0)
], AttendanceController.prototype, "updateEntry", null);
__decorate([
